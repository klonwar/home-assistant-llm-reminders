...
- Lead with two or three spoken reminder examples and explain the result in
...
3. Remove the paragraph describing the repository's lack of household-specific
   data and other similar agent artifacts.
...
configuration, language support, optional system-prompt guidance, time
